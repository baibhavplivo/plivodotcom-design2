# AGENTS.md - Plivo.com Migration Project
...
```css
--plivo-purple: #cd3ef9 --plivo-blue: #323dfe
...
H1: text-[2rem] sm:text-[2.5rem] md:text-[3rem] font-normal leading-[1.1] tracking-[-0.02em]
...
/* Mesh Gradient - use MeshGradient component */
/* Component: src/components/ui/mesh-gradient.tsx */
/* Variants: default (fuchsia/cyan/blue), purple, blue, cyan */
/* Colors used: fuchsia-300, fuchsia-400, cyan-300, blue-400 */
```
...
/* Secondary/Outline */
rounded-md border border-gray-300 text-black hover:bg-gray-50

/* Gradient (special) */
rounded-md bg-gradient-to-r from-[#cd3ef9] to-[#323dfe] text-white
```
...
Reusable mesh gradient background component at `src/components/ui/mesh-gradient.tsx`

```jsx
import MeshGradient from "@/components/ui/mesh-gradient";

// Default (fuchsia/cyan/blue)
<div className="relative">
  <MeshGradient />
  {/* Content */}
</div>

// Variants: "default" | "purple" | "blue" | "cyan"
<MeshGradient variant="purple" />

// Blur levels: "sm" | "md" | "lg" | "xl"
<MeshGradient blur="lg" />

// Custom opacity (0-1)
<MeshGradient opacity={0.5} />

// Combined
<MeshGradient variant="blue" blur="md" opacity={0.7} className="rounded-lg" />
```
...
<Layout title="Page Title | Plivo" description="Page description for SEO">
  ...
  <section className="py-16 lg:py-24 bg-white">
    <div className="container mx-auto max-w-7xl px-4">
      <h1 className="font-sora text-[2rem] sm:text-[2.5rem] md:text-[3rem] font-normal leading-[1.1] tracking-[-0.02em] text-black text-center">
        Page Headline
      </h1>
...
- Do NOT include "Codex", "Anthropic", or "Co-Authored-By" in commit messages
