...
image: "/images/blog/65810b0e6dd9ffc5d4785098_Blog_2FA_PHP.svg"
thumbnail: "/images/blog/65810b0e6dd9ffc5d4785098_Blog_2FA_PHP.svg"
...
</code></pre></div> &nbsp; &nbsp;</div><ul><li>Edit the config.ini file. Replace the PLIVO_AUTH_ID, PLIVO_AUTH_TOKEN, PLIVO_NUMBER, and PHLO_ID placeholders with your own values.<br></li></ul><figure style="max-width:1440px" data-rt-max-width="1440px"><div><img src="/images/blog/65810b7d9d2ea44f23c98fab_php-config.png" alt="Configuration file" width="auto" height="auto" loading="auto"></div></figure><p><strong>Note</strong>: Enter your phone number in E.164 format.</p><h3>Generate the OTP</h3><p>Generate an exclusive six-digit authentication code. To create the OTP, use the time-based OTP generation algorithm. Here’s how it’s done in PHP.</p><div class="language-php highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nv">$code</span> <span class="o">=</span> <span class="nb">random_int</span><span class="p">(</span><span class="mi">100000</span><span class="p">,</span> <span class="mi">999999</span><span class="p">);</span>
