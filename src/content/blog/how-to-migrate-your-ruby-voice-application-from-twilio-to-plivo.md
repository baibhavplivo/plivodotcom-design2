---
title: "How to Migrate Your Ruby Voice Application from Twilio to Plivo"
description: "Plivo's SMS API and Voice API enables businesses to communicate with their customers at global scale. Sign up for free now."
pubDate: "2022-01-13T00:00:00.000Z"
updatedDate: "2025-11-23T03:55:41.000Z"
image: "https://cdn.prod.website-files.com/656ac26f3a3f6e1cc08ba7a5/658017acb81e56d1b6227db7_migrate-ruby-voice.png"
thumbnail: "https://cdn.prod.website-files.com/656ac26f3a3f6e1cc08ba7a5/658017acb81e56d1b6227db7_migrate-ruby-voice.png"
authorName: "Team Plivo"
featured: true
noindex: false
categories: ["migration", "ruby-sdk", "voice-api", "how-to"]
seoTitle: "How to Migrate Your Ruby Voice Application from Twilio to Plivo"
webflowItemId: "6580184c1650bb250fdb4232"
---
...
<div>
 &nbsp; &nbsp;
<figure><pre><code class="language-ruby" data-lang="ruby"><span class="nb">require</span> <span class="s1">'rubygems'</span>
<span class="nb">require</span> <span class="s1">'twilio-ruby'</span>

<span class="n">account_sid</span> <span class="o">=</span> <span class="no">ENV</span><span class="p">[</span><span class="s1">'TWILIO_ACCOUNT_SID'</span><span class="p">]</span>
<span class="n">auth_token</span> <span class="o">=</span> <span class="no">ENV</span><span class="p">[</span><span class="s1">'TWILIO_AUTH_TOKEN'</span><span class="p">]</span>
<span class="vi">@client</span> <span class="o">=</span> <span class="no">Twilio</span><span class="o">::</span><span class="no">REST</span><span class="o">::</span><span class="no">Client</span><span class="p">.</span><span class="nf">new</span><span class="p">(</span><span class="n">account_sid</span>
<span class="p">,</span> <span class="n">auth_token</span><span class="p">)</span>

<span class="n">call</span> <span class="o">=</span> <span class="vi">@client</span><span class="p">.</span><span class="nf">calls</span><span class="p">.</span><span class="nf">create</span><span class="p">(</span>
 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<span class="ss">url: </span>
<span class="s1">'http://demo.twilio.com/docs/classic.mp3'</span><span class="p">,</span>
 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<span class="ss">to: </span><span class="s1">'+14155551212'</span><span class="p">,</span>
 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<span class="ss">from: </span><span class="s1">'+14155551212'</span>
<span class="p">)</span>
...
<span class="n">auth_id</span> <span class="o">=</span> <span class="no">ENV</span><span class="p">[</span><span class="s1">'PLIVO_AUTH_ID'</span><span class="p">]</span>
<span class="n">auth_token</span> <span class="o">=</span> <span class="no">ENV</span><span class="p">[</span><span class="s1">'PLIVO_AUTH_TOKEN'</span><span class="p">]</span>

<span class="n">api</span> <span class="o">=</span> <span class="no">RestClient</span><span class="p">.</span><span class="nf">new</span><span class="p">(</span><span class="n">auth_id</span><span class="p">,</span><span class="n">auth_token</span><span class="p">)</span>

<span class="k">begin</span>
 &nbsp;<span class="n">response</span> <span class="o">=</span> <span class="n">api</span><span class="p">.</span><span class="nf">calls</span><span class="p">.</span><span class="nf">create</span><span class="p">(</span>
 &nbsp; &nbsp;<span class="s1">'+14151234567'</span><span class="p">,</span>
 &nbsp; &nbsp;<span class="p">[</span><span class="s1">'+15671234567'</span><span class="p">],</span>
 &nbsp; &nbsp;<span class="s1">'https://s3.amazonaws.com/static.plivo.com/answer.xml'</span>
 &nbsp;<span class="p">)</span>
...
<div>
 &nbsp; &nbsp;
<figure><pre><code class="language-ruby" data-lang="ruby"><span class="nb">require</span> <span class="s1">'sinatra'</span>
<span class="nb">require</span> <span class="s1">'twilio-ruby'</span>

<span class="n">post</span> <span class="s1">'/twiml'</span> <span class="k">do</span>
 &nbsp;<span class="c1"># Start our TwiML response</span>
 &nbsp;<span class="no">Twilio</span><span class="o">::</span><span class="no">TwiML</span><span class="o">::</span><span class="no">VoiceResponse</span><span class="p">.</span><span class="nf">new</span> <span class="k">do</span> <span class="o">|</span><span class="n">r</span><span class="o">|</span>
 &nbsp; &nbsp;<span class="c1"># Use &lt;Say&gt; to give the caller some
 &nbsp; &nbsp;instructions</span>
 &nbsp; &nbsp;<span class="n">r</span><span class="p">.</span><span class="nf">say</span><span class="p">(</span><span class="ss">message: </span><span class="s1">'hello world!'</span><span class="p">,</span> <span class="ss">voice: </span><span class="s1">'alice'</span><span class="p">)</span>
...
<td>
 &nbsp; &nbsp;<div>
 &nbsp; &nbsp;
<figure><pre><code class="language-ruby" data-lang="ruby"><span class="kp">include</span> <span class="no">Plivo</span>
...
<span class="k">class</span> <span class="nc">PlivoController</span> <span class="o">&lt;</span> <span class="no">ApplicationController</span>
 <span class="k">def</span> <span class="nf">inbound</span>
 &nbsp; &nbsp;<span class="n">response</span> <span class="o">=</span> <span class="no">Response</span><span class="p">.</span><span class="nf">new</span>
 &nbsp; &nbsp;<span class="n">speak_body</span> <span class="o">=</span> <span class="s1">'Hello, you just received your
 &nbsp; &nbsp;first call'</span>
 ...
 &nbsp; &nbsp;<span class="n">xml</span> <span class="o">=</span> <span class="no">Plivo</span><span class="o">::</span><span class="no">PlivoXML</span><span class="p">.</span><span class="nf">new</span><span class="p">(</span><span class="n">response</span><span class="p">)</span>
...
<span class="n">post</span> <span class="s1">'/twiml'</span> <span class="k">do</span>
 ...
 &nbsp; <span class="n">response</span> <span class="o">=</span> <span class="no">Twilio</span><span class="o">::</span><span class="no">TwiML</span><span class="o">::</span><span class="no">VoiceResponse</span><span class="p">.</span>
 &nbsp; <span class="nf">new</span>
 &nbsp; <span class="n">response</span><span class="p">.</span><span class="nf">dial</span><span class="p">(</span><span class="ss">number: </span><span class="s1">'415-123-4567'</span><span class="p">)</span>
 &nbsp; <span class="n">response</span><span class="p">.</span><span class="nf">say</span><span class="p">(</span><span class="ss">message: </span><span class="s1">'Goodbye'</span><span class="p">)</span>
 &nbsp; <span class="nb">puts</span> <span class="n">response</span>
 &nbsp; <span class="k">end</span><span class="p">.</span><span class="nf">to_s</span>
<span class="k">end</span>
...
<td>
 &nbsp; &nbsp;<div>
 &nbsp; &nbsp;
<figure><pre><code class="language-ruby" data-lang="ruby"><span class="k">def</span> <span class="nf">forward</span>
 &nbsp; <span class="n">response</span> <span class="o">=</span> <span class="no">Response</span><span class="p">.</span><span class="nf">new</span>
 ...
 &nbsp; <span class="n">dest_number</span> <span class="o">=</span> <span class="s2">"&lt;destination_number&gt;"</span>
 ...
 &nbsp; <span class="n">xml</span> <span class="o">=</span> <span class="no">PlivoXML</span><span class="p">.</span><span class="nf">new</span><span class="p">(</span><span class="n">response</span><span class="p">)</span>
