---
title: "How to Make and Receive Phone Calls Using Plivo’s Voice API and Python"
description: "How to make and receive outgoing and incoming voice calls using Python with the Plivo Voice API."
pubDate: "2021-02-04T00:00:00.000Z"
updatedDate: "2024-07-08T07:41:14.000Z"
image: "https://uploads-ssl.webflow.com/656ac26f3a3f6e1cc08ba7a5/6582543c77f8cae2e41a1547_make-phone-calls-python.png"
thumbnail: "https://uploads-ssl.webflow.com/656ac26f3a3f6e1cc08ba7a5/6582543c77f8cae2e41a1547_make-phone-calls-python.png"
authorName: "Team Plivo"
featured: true
noindex: false
categories: ["python-sdk", "voice-api", "how-to"]
seoTitle: "How to Make and Receive Phone Calls Using Plivo’s Voice API and Python"
webflowItemId: "658254f4e91f8901ae1ad836"
---
<p>Your company has settled on Plivo to handle its voice and messaging communications, and now it’s your job to start integrating Plivo into your company’s applications. Don’t worry — Plivo has an SDK to help you out. Let’s see how to <a href="https://www.plivo.com/docs/voice/use-cases/make-outbound-calls/python/">make outbound calls</a> and <a href="https://www.plivo.com/docs/voice/use-cases/receive-incoming-calls/python/">handle incoming calls</a> through <a href="/voice" target="_blank">Plivo's Voice API</a> in a Python application.</p><h2>Install the Plivo SDK</h2><p>We’ll presume you already have Python installed. Change to the directory into which you want to install the Plivo Python package and run</p><div class="language-shell highlighter-rouge"><div class="highlight"><pre class="highlight"><code>pip <span class="nb">install </span>plivo
</code></pre></div></div><p>or you can download the source code from <a href="https://github.com/plivo/plivo-python/">our repo</a> and run</p><style>
