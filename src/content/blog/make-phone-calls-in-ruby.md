---
title: "How to Make and Receive Phone Calls Using Plivo’s Voice API and Ruby"
description: "How to make and receive outgoing and incoming voice calls using Ruby with the Plivo Voice API."
pubDate: "2021-02-19T00:00:00.000Z"
updatedDate: "2024-05-23T07:48:56.000Z"
image: "https://uploads-ssl.webflow.com/656ac26f3a3f6e1cc08ba7a5/658251b02f3ddd520785aa91_make-phone-calls-ruby.png"
thumbnail: "https://uploads-ssl.webflow.com/656ac26f3a3f6e1cc08ba7a5/658251b02f3ddd520785aa91_make-phone-calls-ruby.png"
authorName: "Team Plivo"
featured: true
noindex: false
categories: ["ruby-sdk", "voice-api", "how-to"]
seoTitle: "How to Make and Receive Phone Calls Using Plivo’s Voice API and Ruby"
webflowItemId: "6582524df9e3a07ecb526605"
---
<p>Your company has settled on Plivo to handle its voice and messaging communications, and now it’s your job to start integrating Plivo into your company’s applications. Don’t worry — Plivo has an SDK to help you out. Let’s see how to <a href="https://www.plivo.com/docs/voice/use-cases/make-outbound-calls/ruby/">make outbound calls</a> and <a href="https://www.plivo.com/docs/voice/use-cases/receive-incoming-calls/ruby/">handle incoming calls</a> through <a href="/voice" target="_blank">Plivo's vOice API</a> in a Ruby application.</p><h2>Install the Plivo SDK</h2><p>We’ll presume you already have Ruby installed. Change to the directory into which you want to install the Plivo Ruby gem and run</p><style>
...
<span class="n">client</span> <span class="o">=</span> <span class="no">Phlo</span><span class="p">.</span><span class="nf">new</span><span class="p">(</span><span class="s2">"&lt;auth_id&gt;"</span><span class="p">,</span> <span class="s2">"&lt;auth_token&gt;"</span><span class="p">)</span>

<span class="p">\</span><span class="c1"># if credentials are stored in the &nbsp; PLIVO_AUTH_ID and the PLIVO_AUTH_TOKEN environment variables</span>
<span class="p">\</span><span class="c1"># then initialize client as:</span>
<span class="p">\</span><span class="c1"># client = Phlo.new</span>
