      ...
      <div className="relative h-full w-full p-3 sm:p-4">
        ...
        <div className="bg-background rounded-lg border border-border shadow-sm h-full flex flex-col">
          ...
          <div className="flex-1 p-4 space-y-4 overflow-hidden">
            ...
            {/* Brand Vocabulary */}
            <div>
              <label className="text-[11px] font-medium text-muted-foreground font-mono-ui uppercase tracking-[0.1em]">Brand Vocabulary</label>
              <div className="mt-1.5 px-3 py-2 bg-surface rounded-md border border-border text-[11px] text-muted-foreground leading-relaxed">
      ...
      <div className="relative h-full w-full pt-3 sm:pt-4 flex justify-center overflow-hidden">
        ...
        <div className="w-[280px] sm:w-[320px] h-[500px]">
          ...
          <div className="relative rounded-[36px] p-1.5 h-full border border-border-strong bg-muted">
            ...
            {/* Screen */}
            <div className="relative rounded-[32px] overflow-hidden bg-background shadow-inner h-full flex flex-col">
              {/* Status bar */}
              <div className="h-7 bg-muted flex items-center justify-between px-5 text-xs font-medium rounded-t-[32px]">
                <div className="flex items-center gap-1 opacity-50">
                  ...
                  <span className="ml-1 text-foreground text-[10px]">Plivo</span>
                </div>
                <span className="text-foreground opacity-50 text-[10px]">9:41 AM</span>
                <div className="flex items-center gap-1 opacity-50">
                  <span className="text-foreground text-[9px]">100%</span>
              ...
              {/* Messages area */}
              <div className="flex-1 px-3 pb-3 space-y-3 bg-background">
                {/* AI message */}
                <div
                ...
                >
                  <div className="rounded-2xl rounded-bl-sm px-3 py-2 max-w-[85%] bg-gray-200">
                    <p className="text-[13px] text-foreground leading-snug">Hi Sarah! 👋 We noticed you left some items in your cart. Ready to complete your order?</p>
                  </div>
                </div>
                ...
                >
                  <div className="rounded-2xl rounded-bl-sm px-3 py-2 max-w-[85%] bg-gray-200">
                    <p className="text-[13px] text-foreground leading-snug">The blue dress runs true to size. Based on your orders, I'd recommend Medium. Add to cart?</p>
                  </div>
                </div>
        ...
        <div className="bg-background rounded-lg border border-border shadow-sm h-full flex flex-col">
          ...
          <div className="px-4 py-3 border-b border-border flex items-center gap-3">
            ...
            <div className="flex-1">
              <p className="text-sm font-semibold text-foreground">Content Generator</p>
              <p className="text-[10px] text-muted-foreground">A/B variants generated</p>
            </div>
            <span className="text-[10px] px-2 py-1 rounded-md bg-green-50 dark:bg-green-900/30 text-green-700 dark:text-green-300 font-medium border border-green-200 dark:border-green-900/50">Ready</span>
          </div>
            ...
            <div className="grid grid-cols-2 gap-3 h-full">
              ...
              <div className="rounded-lg border border-border bg-background p-3 flex flex-col">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <div className="text-right">
                    <p className="text-base font-bold text-muted-foreground">87%</p>
                    <p className="text-[9px] text-muted-foreground">score</p>
                  </div>
                </div>
          ...
          <div className="px-4 py-3 border-t border-border bg-surface/50">
            <div className="grid grid-cols-3 gap-3">
              ...
              <div className="text-center">
                <p className="text-lg font-semibold text-primary">8.2x</p>
      ...
      <div className="relative h-full w-full p-3 sm:p-4">
        ...
        <div className="bg-background rounded-lg border border-border shadow-sm h-full flex flex-col">
          ...
          <div className="px-4 py-3 border-b border-border flex items-center gap-3">
            ...
            <span className="text-[10px] px-2 py-1 rounded-md bg-green-50 dark:bg-green-900/30 text-green-700 dark:text-green-300 font-medium border border-green-200 dark:border-green-900/50">Live</span>
          </div>
          ...
          <div className="px-4 py-3 border-b border-border bg-surface/50">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-[10px] text-muted-foreground">Based on 24 interactions • Last active 2h ago</p>
              </div>
            </div>
          </div>
          ...
          <div className="px-4 py-2.5 border-t border-border flex items-center justify-between">
            <span className="text-[10px] text-muted-foreground">ML model v3.2</span>
            <span className="text-[10px] font-medium text-foreground/80">3.2x conversion lift</span>
          </div>
        </div>
      </div>
    </div>
      ...
      <div className="relative h-full w-full p-3 sm:p-4">
        ...
        <div className="bg-background rounded-lg border border-border shadow-sm h-full flex flex-col">
          ...
          <div className="px-4 py-3 border-b border-border flex items-center gap-3">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <p className="text-[10px] text-muted-foreground">8 integrations connected</p>
              </div>
            </div>
            <span className="text-[10px] px-2 py-1 rounded-md bg-green-50 dark:bg-green-900/30 text-green-700 dark:text-green-300 font-medium border border-green-200 dark:border-green-900/50">Synced</span>
          </div>
            ...
            <div className="flex items-center justify-between gap-1.5">
              {brands.map((brand, i) => (
                <div key={i} className="flex flex-col items-center gap-1">
                  <div className="w-9 h-9 rounded-lg bg-surface border border-border flex items-center justify-center p-1.5">
                    <img
                      src={brand.logo}
                      alt={brand.name}
          ...
          <div className="px-4 py-3 bg-surface/50 border-b border-border">
            <p className="text-[10px] text-muted-foreground font-medium font-mono-ui uppercase tracking-[0.1em] mb-2">Indexed Data</p>
            <div className="grid grid-cols-3 gap-3">
          ...
          <div className="flex-1 p-4 overflow-hidden">
            <p className="text-[10px] text-muted-foreground font-medium font-mono-ui uppercase tracking-[0.1em] mb-2">Sync Activity</p>
            <div className="space-y-2">
              {[
                ...
                <div key={i} className="flex items-center gap-2 text-[10px] p-2 bg-surface rounded-md">
                  <span className="w-1.5 h-1.5 rounded-full bg-green-500 flex-shrink-0" />
                  <span className="text-foreground/80 flex-1">{activity.action}</span>
                  <span className="text-muted-foreground px-1.5 py-0.5 bg-background rounded border border-border">{activity.source}</span>
        ...
        <div className="bg-background rounded-xl border border-border shadow-sm h-full flex flex-col">
          ...
          <div className="px-4 py-3.5 border-b border-border flex items-center gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-[11px] text-muted-foreground">Always-on engagement</p>
            </div>
            <div className="text-right">
              <p className="text-base font-semibold bg-gradient-to-r from-primary to-primary bg-clip-text text-transparent">99.9%</p>
          ...
          <div className="px-4 py-4 border-b border-border flex-1">
            <div className="flex items-center justify-between mb-4">
              ...
              <p className="text-[11px] text-foreground font-medium">2,847 today</p>
            </div>
            {/* Chart area */}
                ...
                {hourlyData.map((item, i) => (
                  <div key={i} className="flex-1 flex flex-col items-center">
                    <div className="w-full flex items-end justify-center h-[60px]">
                      <div
                        className="w-full max-w-[28px] rounded-t-sm bg-gradient-to-t from-primary to-[#5b63ff] transition-all duration-700 ease-out"
                        style={{
          ...
          <div className="px-4 py-3">
            <div className="grid grid-cols-3 gap-2.5">
              <div className="text-center py-2.5 px-2 bg-background rounded-lg border border-border">
                <p className="text-xl font-semibold text-foreground">3s</p>
          ...
          <div className="px-4 pb-4">
            <div className="flex items-center gap-3 p-3.5 bg-surface rounded-xl border border-border">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[11px] text-muted-foreground">412 conversations handled overnight</p>
              </div>
              <div className="text-right flex-shrink-0">
                <p className="text-[15px] font-semibold bg-gradient-to-r from-primary to-[#5b63ff] bg-clip-text text-transparent">$8.4k</p>
