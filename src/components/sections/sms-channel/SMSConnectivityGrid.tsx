      ...
      <div className="relative h-full w-full p-3 flex items-center justify-center">
        ...
        <div className="flex gap-2.5 h-full w-full max-w-[320px]">
          ...
          <div className="flex-1 flex flex-col gap-2">
            {/* Throughput metric */}
            <div className="bg-background rounded-lg border border-border p-3 flex-1 flex flex-col justify-center">
              <div className="flex items-center gap-1.5 mb-1">
                ...
                <span className="text-[11px] text-muted-foreground font-medium">Throughput</span>
              </div>
              <p className="text-[20px] font-semibold bg-gradient-to-r from-primary to-black dark:to-white bg-clip-text text-transparent leading-none">10K</p>
              <p className="text-[11px] text-muted-foreground mt-0.5">msgs/sec</p>
            </div>
            ...
            <div className="bg-background rounded-lg border border-border p-3 flex-1 flex flex-col justify-center">
              <div className="flex items-center gap-1.5 mb-1">
                ...
                <span className="text-[11px] text-muted-foreground font-medium">Latency</span>
              </div>
              <p className="text-[20px] font-semibold bg-gradient-to-r from-primary to-black dark:to-white bg-clip-text text-transparent leading-none">&lt;3s</p>
              <p className="text-[11px] text-muted-foreground mt-0.5">avg delivery</p>
            </div>
          </div>

          {/* Right column - SMS Delivery list */}
          <div className="flex-1 bg-background rounded-lg border border-border p-2.5 flex flex-col">
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-[10px] text-muted-foreground font-medium">SMS Delivery</span>
              </div>
              <span className="text-[9px] px-1.5 py-0.5 rounded bg-green-50 dark:bg-green-900/30 text-green-600 dark:text-green-300 font-medium">Live</span>
            </div>
            ...
            <div className="flex-1 space-y-1 overflow-hidden">
              {[
                ...
                <div key={i} className="flex items-center gap-2 px-2 py-1.5 rounded bg-surface">
                  ...
                  <span className="text-[10px] font-mono text-muted-foreground truncate flex-1">{item.number}</span>
            ...
            <div className="flex items-center justify-between pt-1.5 mt-1 border-t border-border">
              <span className="text-[9px] text-muted-foreground">99% delivered</span>
              <span className="text-[9px] font-medium text-muted-foreground">1.2M sent</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="bg-background rounded-lg border border-border h-full w-full max-w-[260px] flex flex-col">
          ...
          <div className="px-2.5 py-1.5 border-b border-border flex items-center justify-between">
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[11px] font-semibold text-foreground">Fraud Scanner</span>
            </div>
            <span className="text-[9px] px-1.5 py-0.5 rounded bg-green-50 dark:bg-green-900/30 text-green-600 dark:text-green-300 font-medium">Active</span>
          </div>
          ...
          <div className="px-2.5 py-1.5 border-t border-border flex items-center justify-between">
            <span className="text-[10px] text-muted-foreground">2.4K blocked today</span>
            <span className="text-[10px] font-medium text-foreground/80">99.8% legitimate</span>
          </div>
        </div>
      </div>
    ...
    <div className="relative h-48 w-full rounded-lg overflow-hidden" style={{ backgroundImage: 'radial-gradient(circle, hsl(var(--border)) 1px, transparent 1px)', backgroundSize: '16px 16px', backgroundPosition: 'center center' }}>
      <div className="relative h-full w-full flex items-center justify-center">
        ...
        <div className="relative w-[280px] h-[150px]">
          {/* Back card (top-left) */}
          <div
            className="absolute -skew-y-[8deg] bg-background rounded-lg border border-border shadow-sm px-3 py-2.5 w-[230px]"
          ...
          >
            <div className="flex items-center gap-2.5">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-semibold text-foreground">Carrier Network</p>
                <p className="text-[11px] text-muted-foreground truncate">Direct carrier connections</p>
              </div>
            </div>
          </div>
          ...
          >
            <div className="flex items-center gap-2.5">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-semibold text-foreground">Messaging Platform</p>
                <p className="text-[11px] text-muted-foreground truncate">Enterprise SMS gateway</p>
              </div>
            </div>
          </div>
          ...
          <div
            className="absolute -skew-y-[8deg] bg-background rounded-lg border border-border px-3 py-2.5 w-[230px]"
          ...
          >
            <div className="flex items-center gap-2.5">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-semibold text-foreground">Marketing Suite</p>
                <p className="text-[11px] text-muted-foreground truncate">Campaign tools & analytics</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <div className="relative h-48 w-full rounded-lg overflow-hidden" style={{ backgroundImage: 'radial-gradient(circle, hsl(var(--border)) 1px, transparent 1px)', backgroundSize: '16px 16px', backgroundPosition: 'center center' }}>
      <div className="relative h-full w-full flex items-center justify-center p-3">
        ...
        <div className="absolute left-4 top-4 z-10">
          <div className="bg-background/95 backdrop-blur-sm rounded-full px-3 py-1.5 shadow-sm border border-border/60 flex items-center gap-1.5">
            <span className="text-[16px] font-semibold bg-gradient-to-r from-primary to-black dark:to-white bg-clip-text text-transparent leading-none">&gt;99%</span>
      ...
      <div className="relative h-full w-full">
        ...
        >
          <Globe
            ...
            darkGlowColor={[0.06, 0.07, 0.11]}
            darkMarkerColor={[0.8, 0.24, 0.98]}
            darkOpacity={0.9}
            interactive={false}
          />
        </div>
        ...
        <div className="absolute right-4 top-1/2 -translate-y-1/2 z-10">
          <div className="bg-background/95 backdrop-blur-sm rounded-full px-4 py-2 shadow-sm border border-border/60">
            <div className="flex items-center gap-1.5">
              <span className="text-[22px] font-semibold bg-gradient-to-r from-primary to-black dark:to-white bg-clip-text text-transparent leading-none">190+</span>
      ...
      <div className="relative h-full w-full p-4">
        ...
        <div className="absolute right-4 top-4 z-10">
          <div className="bg-background/95 backdrop-blur-sm rounded-full pl-2.5 pr-3 py-1.5 shadow-sm border border-border/60 flex items-center gap-2">
            ...
            <span className="text-[18px] font-semibold bg-gradient-to-r from-primary to-black dark:to-white bg-clip-text text-transparent leading-none">99.99%</span>
          </div>
        </div>

        {/* Platform Uptime label - top left */}
        <div className="absolute left-4 top-4">
          <span className="text-[11px] font-medium text-muted-foreground">Platform Uptime</span>
        </div>
