    ...
    >
      ...
      <div className="container grid gap-8 lg:grid-cols-3 lg:gap-40">
        ...
        <div className="flex flex-col gap-8 lg:col-span-1">
          ...
          >
            <h2 className="text-balance text-4xl tracking-tight lg:text-5xl">
              Navigate your{" "}
            ...
            {features.map((feature, index) => {
              ...
              return (
                <motion.button
                  ...
                  className={cn(
                    `flex h-16 w-16 cursor-pointer items-center justify-center rounded-sm border border-input transition-all duration-300 hover:bg-border/50`,
                    isActive && "bg-border",
                  )}
                >
        ...
        <motion.div
          className="md:mask-r-from-60% md:mask-r-to-100% select-none lg:col-span-2"
          initial={prefersReducedMotion ? "visible" : "hidden"}
          whileInView="visible"
          ...
          >
            <CarouselContent className="h-full">
              {features.map((feature) => (
                ...
                >
                  <Card className="aspect-[284/362] h-full border-input bg-border !pb-0 transition-all duration-300 hover:shadow-lg lg:aspect-[384/562]">
                    <CardHeader>
                    ...
                    <CardContent className="relative h-full">
                      <div className="relative h-full overflow-hidden rounded-lg border border-input bg-card dark:bg-card-foreground">
                        <img
