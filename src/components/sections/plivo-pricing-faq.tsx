...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "New accounts receive $10 in free credits with no credit card required. This allows you to test our Voice, SMS, WhatsApp, and AI Agent capabilities before committing to any paid usage.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes, you can configure spending alerts and limits in your dashboard. Free trial accounts are limited to $2500 in monthly usage. You can also set up automatic top-ups to ensure uninterrupted service.",
  },
  {
