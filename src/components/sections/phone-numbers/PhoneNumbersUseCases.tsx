...
const useCases: UseCase[] = [
  {
    ...
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 3.75l3 3m0 0l3-3m-3 3v-6" transform="rotate(90 18.75 3.75)" />
      </svg>
    ),
  },
  {
  ...
  {
    title: "SMS autoresponder",
    description:
      "Automatically respond to your customers while you're away.",
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
  ...
  {
    title: "Scalable cloud IVR",
    description:
      "Build powerful multilevel IVR menus to route calls intelligently.",
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
