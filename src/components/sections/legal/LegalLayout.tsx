...
export default function LegalLayout({ activePage, children }: LegalLayoutProps) {
  return (
    <>
      {/* Hero */}
      <section className="bg-white pt-16 sm:pt-20 md:pt-24 pb-10">
      ...
      <section className="bg-white pb-16 lg:pb-24">
        <div className="container mx-auto max-w-7xl px-4">
          <div className="lg:grid lg:grid-cols-[240px_1fr] lg:gap-10 lg:items-start">
            {/* Sidebar */}
            <nav className="mb-8 lg:mb-0 lg:sticky lg:top-28">
