...
function SeamlessIntegrationsIllustration() {
  const brands: { name: string; logo: React.ReactNode }[] = [
    { name: "Shopify", logo: <img src="https://cdn.simpleicons.org/shopify/96BF48" alt="Shopify" className="w-8 h-8 object-contain" /> },
    { name: "HubSpot", logo: <img src="https://cdn.simpleicons.org/hubspot/FF7A59" alt="HubSpot" className="w-8 h-8 object-contain" /> },
    { name: "Zendesk", logo: <img src="https://cdn.simpleicons.org/zendesk/03363D" alt="Zendesk" className="w-8 h-8 object-contain" /> },
    { name: "Zoho", logo: (
    ...
    { name: "Stripe", logo: <img src="https://cdn.simpleicons.org/stripe/635BFF" alt="Stripe" className="w-8 h-8 object-contain" /> },
