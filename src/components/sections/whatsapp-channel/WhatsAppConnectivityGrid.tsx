      ...
      <div className="relative h-full w-full p-3 flex items-center justify-center">
        <div className="flex flex-col items-center">
          ...
          <div className="bg-background rounded-xl shadow-sm border border-border p-4 mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Official Meta Partner</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 bg-background rounded-full px-4 py-2 shadow-sm border border-border">
            ...
            <span className="text-xs font-medium text-foreground/80">Verified Business</span>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="relative h-48 w-full rounded-lg overflow-hidden" style={{ backgroundImage: 'radial-gradient(circle, hsl(var(--border)) 1px, transparent 1px)', backgroundSize: '16px 16px', backgroundPosition: 'center center' }}>
      <div className="relative h-full w-full p-3 flex items-center justify-center">
        ...
        <div className="bg-background rounded-xl shadow-sm border border-border w-full max-w-[200px]">
          <div className="px-3 py-2">
            <p className="text-[12px] text-foreground">How would you like to proceed?</p>
          </div>
          <div className="border-t border-border">
            {["View Products", "Talk to Agent", "Check Order"].map((btn, i) => (
              <button
                key={i}
                className="w-full px-3 py-2 text-[12px] font-medium text-primary border-b border-border last:border-0 hover:bg-primary/5 transition-colors text-center"
              >
                {btn}
              </button>
            ))}
    ...
    <div className="relative h-48 w-full rounded-lg overflow-hidden" style={{ backgroundImage: 'radial-gradient(circle, hsl(var(--border)) 1px, transparent 1px)', backgroundSize: '16px 16px', backgroundPosition: 'center center' }}>
      <div className="relative h-full w-full p-3 flex items-center justify-center">
        <div className="w-full max-w-[250px]">
          {/* Broadcast header */}
          <div className="bg-background rounded-lg border border-border shadow-sm px-3 py-2 mb-2 flex items-center justify-between">
            <div className="flex items-center gap-2">
              <div className="w-6 h-6 rounded-full bg-gradient-to-br from-primary to-black flex items-center justify-center">
              ...
              <div>
                <p className="text-[10px] font-semibold text-foreground">Holiday sale blast</p>
                <p className="text-[8px] text-muted-foreground">4,280 recipients</p>
              </div>
            </div>
          ...
          <div className="space-y-1">
            {recipients.map((r, i) => (
              <div key={i} className="bg-background rounded-md border border-border px-2.5 py-1.5 flex items-center gap-2">
                <div className="w-5 h-5 rounded-full bg-muted flex items-center justify-center flex-shrink-0">
                  <span className="text-[8px] font-semibold text-muted-foreground">{r.name.charAt(0)}</span>
                </div>
                <div className="flex-1 min-w-0">
                  <p className="text-[10px] font-medium text-foreground truncate">{r.name}</p>
                </div>
                <span className="text-[8px] text-muted-foreground bg-surface px-1.5 py-0.5 rounded-full">{r.segment}</span>
          ...
          <div className="bg-background rounded-xl shadow-sm border border-border p-3">
            <div className="flex items-center gap-2 mb-2.5">
              ...
              <div className="flex-1">
                <p className="text-[11px] font-medium text-foreground">Chat to Voice</p>
                <p className="text-[9px] text-muted-foreground">Same WhatsApp thread</p>
              </div>
            </div>
            {/* Flow visualization */}
            <div className="flex items-center gap-2">
              <div className="flex-1 flex items-center justify-center gap-1.5 py-1.5 rounded-md border border-border bg-background">
                ...
                <p className="text-[9px] font-medium text-muted-foreground">Chat</p>
              </div>
              ...
              <div className="flex-1 flex items-center justify-center gap-1.5 py-1.5 rounded-md border border-border bg-background">
                ...
                <p className="text-[9px] font-medium text-muted-foreground">Voice</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-full max-w-[230px]">
          <div className="bg-background rounded-xl shadow-sm border border-border p-3">
            <div className="flex items-center justify-between mb-2.5">
              <p className="text-[10px] font-semibold text-foreground">Live Transcript</p>
            ...
            <div className="space-y-1.5">
              {[
                ...
                <div key={i} className="rounded-md border border-border bg-surface px-2 py-1.5">
                  <p className="text-[8px] font-semibold text-muted-foreground mb-0.5">{line.speaker}</p>
                  <p className="text-[9px] text-foreground/80 leading-[1.3]">{line.text}</p>
                </div>
              ))}
            </div>
          </div>
    ...
    <div className="relative h-48 w-full rounded-lg overflow-hidden" style={{ backgroundImage: 'radial-gradient(circle, hsl(var(--border)) 1px, transparent 1px)', backgroundSize: '16px 16px', backgroundPosition: 'center center' }}>
      <div className="relative h-full w-full p-3 flex items-center justify-center">
        <div className="w-full max-w-[230px]">
          {/* Call routing panel */}
          <div className="bg-background rounded-xl shadow-sm border border-border p-3">
            <p className="text-[10px] font-semibold text-foreground mb-2">Smart Call Routing</p>
            {/* Routing rules */}
            <div className="space-y-1.5">
              {[
                ...
                <div key={i} className="flex items-center gap-2 text-[10px]">
                  <span className="text-muted-foreground flex-1 truncate">{rule.label}</span>
            ...
            {/* Latency badge */}
            <div className="mt-2.5 flex items-center gap-1.5 p-1.5 bg-surface rounded-md">
              <span className="w-1.5 h-1.5 rounded-full bg-green-500 flex-shrink-0" />
              <span className="text-[9px] text-muted-foreground">Avg. wait time: <span className="font-semibold text-foreground">{"<"}3s</span></span>
            </div>
          </div>
        </div>
      </div>
