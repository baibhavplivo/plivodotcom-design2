      ...
      <div className="container mx-auto max-w-7xl px-4">
        ...
        <div className="grid gap-6 sm:grid-cols-2">
          {reasons.map((reason, index) => (
            <div
              key={index}
              className="rounded-xl bg-white border border-gray-200 p-6 sm:p-8 transition-all hover:shadow-lg hover:border-gray-300"
            >
              <span className="text-[#323dfe] mb-4 block">{reason.icon}</span>
