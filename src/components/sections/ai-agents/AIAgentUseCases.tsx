...
function IllustrationWrapper({ children, className }: { children: React.ReactNode; className?: string }) {
  return (
    <div className={cn("relative h-[244px] w-full rounded-xl overflow-hidden", className)} style={{ backgroundImage: 'radial-gradient(circle, hsl(var(--border)) 1px, transparent 1px)', backgroundSize: '16px 16px', backgroundPosition: 'center center' }}>
  ...
  return (
    <IllustrationWrapper>
      <div className="flex-1 flex flex-col items-center justify-center px-4 gap-0">
        ...
        <div className="flex items-center gap-2 rounded-lg border border-border bg-background px-3 py-1.5 shadow-sm max-w-[220px] w-full overflow-hidden">
          ...
          <span className="text-[11px] font-semibold text-foreground truncate">Receive message on WhatsApp</span>
        </div>
        ...
        <div className="rounded-xl border border-gray-900 bg-background px-3 py-2 shadow-sm max-w-[220px] w-full">
          <div className="flex items-center justify-between mb-1">
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[11px] font-semibold text-foreground">Capture Leads</span>
            </div>
            <svg className="w-3 h-3 text-muted-foreground" fill="currentColor" viewBox="0 0 16 16">
              <circle cx="8" cy="3" r="1.2" />
              <circle cx="8" cy="8" r="1.2" />
              <circle cx="8" cy="13" r="1.2" />
            </svg>
          </div>
          <p className="text-[9px] text-muted-foreground leading-snug mb-1">
            Greet the prospects and ask gather their details and requirements.
          </p>
          <span className="text-[8px] font-medium text-muted-foreground font-mono-ui uppercase tracking-[0.1em]">AI Conversation</span>
        </div>

        {/* Connector + plus */}
        <div className="flex flex-col items-center">
          <div className="w-px h-2 bg-gray-300" />
          <div className="w-4 h-4 rounded-full border border-border-strong bg-background flex items-center justify-center">
            <svg className="w-2.5 h-2.5 text-muted-foreground" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
        ...
        <div className="flex items-center gap-2 mt-1">
          <div className="w-8 h-8 rounded-lg bg-background border border-border shadow-sm flex items-center justify-center p-1.5">
    ...
    <IllustrationWrapper>
      <div className="flex-1 flex flex-col items-center justify-center px-4 gap-0">
        ...
        <div className="flex items-center gap-2 rounded-lg border border-border bg-background px-3 py-1.5 shadow-sm max-w-[220px] w-full overflow-hidden">
          ...
          <span className="text-[11px] font-semibold text-foreground truncate">Incoming call on Voice</span>
        </div>
        ...
        <div className="rounded-xl border border-gray-900 bg-background px-3 py-2 shadow-sm max-w-[220px] w-full">
          <div className="flex items-center justify-between mb-1">
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[11px] font-semibold text-foreground">Resolve Query</span>
            </div>
            <svg className="w-3 h-3 text-muted-foreground" fill="currentColor" viewBox="0 0 16 16">
              <circle cx="8" cy="3" r="1.2" />
              <circle cx="8" cy="8" r="1.2" />
        ...
        <div className="rounded-xl border border-gray-900 bg-background px-3 py-2 shadow-sm max-w-[220px] w-full">
          <div className="flex items-center justify-between mb-1">
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[11px] font-semibold text-foreground">Book Appointment</span>
            </div>
            <svg className="w-3 h-3 text-muted-foreground" fill="currentColor" viewBox="0 0 16 16">
              <circle cx="8" cy="3" r="1.2" />
              <circle cx="8" cy="8" r="1.2" />
        ...
        <div className="rounded-xl border border-gray-900 bg-background px-3 py-2 shadow-sm max-w-[220px] w-full">
          <div className="flex items-center justify-between mb-1">
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[11px] font-semibold text-foreground">Run Diagnostics</span>
            </div>
            <svg className="w-3 h-3 text-muted-foreground" fill="currentColor" viewBox="0 0 16 16">
              <circle cx="8" cy="3" r="1.2" />
              <circle cx="8" cy="8" r="1.2" />
  ...
  return (
    <IllustrationWrapper>
      <div className="flex-1 flex flex-col items-center justify-center px-4 gap-0">
        ...
        <div className="flex items-center gap-2 rounded-lg border border-border bg-background px-3 py-1.5 shadow-sm max-w-[220px] w-full overflow-hidden">
          <div className="w-5 h-5 rounded-md bg-green-50 dark:bg-green-900/30 flex items-center justify-center flex-shrink-0">
            <svg className="w-3 h-3 text-green-600 dark:text-green-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 12a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H8.25m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H12m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.764 9.764 0 01-2.555-.337A5.972 5.972 0 015.41 20.97a5.969 5.969 0 01-.474-.065 4.48 4.48 0 00.978-2.025c.09-.457-.133-.901-.467-1.226C3.93 16.178 3 14.189 3 12c0-4.556 4.03-8.25 9-8.25s9 3.694 9 8.25z" />
            </svg>
          </div>
          <span className="text-[11px] font-semibold text-foreground truncate">Receive SMS message</span>
        </div>
        ...
        <div className="rounded-xl border border-gray-900 bg-background px-3 py-2 shadow-sm max-w-[220px] w-full">
          <div className="flex items-center justify-between mb-1">
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[11px] font-semibold text-foreground">Collect Feedback</span>
            </div>
            <svg className="w-3 h-3 text-muted-foreground" fill="currentColor" viewBox="0 0 16 16">
              <circle cx="8" cy="3" r="1.2" />
              <circle cx="8" cy="8" r="1.2" />
    ...
    <IllustrationWrapper>
      <div className="flex-1 flex flex-col items-center justify-center px-4 gap-0">
        ...
        <div className="flex items-center gap-2 rounded-lg border border-border bg-background px-3 py-1.5 shadow-sm max-w-[220px] w-full overflow-hidden">
          ...
          <span className="text-[11px] font-semibold text-foreground truncate">New chat message</span>
        </div>
        ...
        <div className="rounded-xl border border-gray-900 bg-background px-3 py-2 shadow-sm max-w-[220px] w-full">
          <div className="flex items-center justify-between mb-1">
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[11px] font-semibold text-foreground">Route & Engage</span>
            </div>
            <svg className="w-3 h-3 text-muted-foreground" fill="currentColor" viewBox="0 0 16 16">
              <circle cx="8" cy="3" r="1.2" />
              <circle cx="8" cy="8" r="1.2" />
