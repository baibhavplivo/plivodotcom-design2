...
export default function AIAgentsHero() {
  ...
  return (
    <section className="bg-background border-t border-border pt-16 sm:pt-20 md:pt-24 pb-12 sm:pb-16">
      <div className="container mx-auto max-w-7xl px-4">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10 md:mb-14">
          ...
          <div className="flex flex-col sm:flex-row gap-3 mt-8 justify-center">
            <a
              href="/contact/sales/"
              className="inline-flex items-center justify-center px-6 py-3 text-base font-medium border border-border-strong text-foreground rounded-md hover:bg-surface transition-colors"
            >
              Contact Sales
            </a>
            <a
              ...
              className="inline-flex items-center justify-center px-6 py-3 text-base font-medium bg-foreground text-background rounded-md cta-hover-gradient transition-colors"
            >
              {signupLabel}
            </a>
          </div>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex border-b border-border">
            {TABS.map((tab, i) => (
              ...
              >
                <span className={activeTab === i ? "text-foreground" : "text-muted-foreground"}>
                  {tab.label}
                </span>
                {/* Progress bar */}
          ...
          <div className="mt-6 rounded-xl border border-border bg-surface overflow-hidden">
            {/* Chat header */}
            <div className="flex items-center gap-3 px-5 py-3 bg-background border-b border-border">
              <div className="w-8 h-8 rounded-full bg-gradient-to-br from-primary to-black flex items-center justify-center">
                <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 014.5 0m0 0v5.714c0 .597.237 1.17.659 1.591L19.8 15.3M14.25 3.104c.251.023.501.05.75.082M19.8 15.3l-1.57.393A9.065 9.065 0 0112 15a9.065 9.065 0 00-6.23.693L5 14.5m14.8.8l1.402 1.402c1.232 1.232.65 3.318-1.067 3.611A48.309 48.309 0 0112 21c-2.773 0-5.491-.235-8.135-.687-1.718-.293-2.3-2.379-1.067-3.61L5 14.5" />
                </svg>
              </div>
              <div>
                <div className="text-sm font-semibold text-foreground">{TABS[activeTab].label}</div>
                <div className="text-xs text-green-600 dark:text-green-300 flex items-center gap-1">
            ...
            <div className="px-5 pb-4">
              <div className="flex items-center gap-2 bg-background rounded-full border border-border px-4 py-2.5 shadow-sm">
